    ...
    <v-layout wrap>
      ...
      >
        <material-chart-card
          ...
          type="Line"
        >
          <h4 class="title font-weight-light">Статистика использования терминов за месяц</h4>
      ...
      >
        <material-chart-card
          ...
          type="Bar"
        >
          <h4 class="title font-weight-light">Кол-во протоколов/месяц</h4>
          <p class="category d-inline-flex font-weight-light">
            <v-icon
              color="green"
              small
            ...
            <v-row align='right'>
                        <v-dialog flat v-model="dialog" color="primary" width="500">
                          <template v-slot:activator="{ on }">
                            <v-btn color='#553D80' dark v-on="on">Добавить термин</v-btn>
                          </template>
                          <v-card>
                        ...
                        <v-dialog flat v-model="dialog1" color="primary" width="500">
                          <template v-slot:activator="{ on }">
                            <v-btn color="#356276" dark v-on="on">Добавить обьяснение</v-btn>
                          </template>
                          <v-card>
                        ...
                        <v-dialog flat v-model="dialog2" color="primary" width="500">
                          <template v-slot:activator="{ on }">
                            <v-btn color="#BBAE50" dark v-on="on">Назначить испонителей</v-btn>
                          </template>
                          <v-card>
                            <v-card-title color='general'>Подробности выполнения:</v-card-title>
                          </v-card>
